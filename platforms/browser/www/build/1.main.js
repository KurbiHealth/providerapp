...
SelectElementPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-select-element',template:/*ion-inline-start:"/home/mati/Development/Kurbi/providerapp/src/pages/select-element/select-element.html"*/'<!--\n  Generated template for the SelectElementPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Select</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-list>\n    <ion-item *ngFor="let bot of currentItems">\n      <ion-label>{{bot.name}}</ion-label>\n      <ion-checkbox color="dark" checked="true"></ion-checkbox>\n    </ion-item>\n  </ion-list>\n\n</ion-content>\n\n<ion-footer>\n  <ion-toolbar>\n    <ion-buttons right>\n      <button ion-button>Done</button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"/home/mati/Development/Kurbi/providerapp/src/pages/select-element/select-element.html"*/,
    }),
